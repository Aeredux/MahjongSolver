...
A REST API server providing AI-powered move suggestions and call decisions for Japanese Riichi Mahjong, designed for integration with FF14 Doman Mahjong plugin.
...
This is a personal project for FF14 plugin integration. See `docs/future-features.md` for planned enhancements.
